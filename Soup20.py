            ...
            if string.strip() == 'exit':
                i = 1
                 ...
                 if member(string[string.index('get') + 4:],name_count):
                    ...
                    print 'Undefined'
                 #both above and below work, but above is better
                #for item in variable_list:
                #    print item, '=', variable_list[item]
                                 
            elif member('=', string) and string.count('=') == 1:
                if string.index('=') - 1 == ' ':
                    ...
                    variable_list[string[:string.index('=')]] = string[string.index('=') + 2:]
                    print string[:string.index('=')].capitalize() + ' defined'
                    name_count.append(string[:string.index('=')])
                ...
                if member('[', string) and member(']',string):
